      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">
          {photos.slice(0, 8).map((photo, index) => (
            <div
              key={index}
              className="relative group rounded-xl border-2 shadow-md overflow-hidden isolation-auto"
            >
              <a
              ...
              <div className="max-h-0 overflow-hidden group-hover:max-h-[300px] transition-all duration-300 bg-[#f5efe7] text-[#213555] rounded-b-xl">
